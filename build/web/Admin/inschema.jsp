...
<html><%@ include file="Head.jsp"%><body>
	...
	<span><span class="style3"><p>Add New Schema of Re-charge:-</p></span></span>
<form name="form6" method="post" action="addschema.jsp" onSubmit="return schemacheck()">
...
<br><P style="TEXT-ALIGN: center; MARGIN-BOTTOM: 0pt"><INPUT type=submit value="SUBMIT"><INPUT type=reset value="RESET"></P></form>
<script type="text/javascript">
function schemacheck()
{
if((document.form6.Creamt.value=="")||(isNaN(document.form6.Creamt.value)))
{
alert("Re-chage amount must be valid!!!");
return false;
}
if((document.form6.Cttamt.value=="")||(isNaN(document.form6.Cttamt.value)))
{
alert("Talk time amount must be valid!!!");
return false;
}
if((document.form6.Catpfv.value=="")||(isNaN(document.form6.Catpfv.value)))
{
alert("Time period for Validity must be require!!!");
return false;
}
if((document.form6.Crloc.value=="")||(isNaN(document.form6.Crloc.value)))
{
alert("Local Call Rate must be require!!!");
return false;
}
if((document.form6.Crstd.value=="")||(isNaN(document.form6.Crstd.value)))
{
alert("STD Call Rate must be require!!!");
return false;
}
if((document.form6.Crisd.value=="")||(isNaN(document.form6.Crisd.value)))
{
alert("ISD Call Rate must be require!!!");
return false;
}
if((document.form6.Srloc.value=="")||(isNaN(document.form6.Srloc.value)))
{
alert("Local SMS Rate must be require!!!");
return false;
}
if((document.form6.Srstd.value=="")||(isNaN(document.form6.Srstd.value)))
{
alert("STD SMS Rate must be require!!!");
return false;
}
if((document.form6.Srisd.value=="")||(isNaN(document.form6.Srisd.value)))
{
